...
<body>
	...
	<div class="wrap">
		...
		<form action="login.php" method="post">
			...
			<input class="" type="password" name="pass" placeholder="Mot de passe" value="" required>

			<input type="submit" name="login" value="Se connecter" class="">

			<h6 class="pt-3">Vous n'avez pas de compte? <a href="register.php">Enregistrez-vous</a></h6>
		</form>
	</div>
